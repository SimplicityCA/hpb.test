...
class SiteTextTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $text1->image = 'quienes_somos_01.jpg';
        $text1->location = 'HOME';
        $text1->save();
